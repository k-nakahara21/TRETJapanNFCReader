...
extension IndividualNumberReader {
    ...
    internal func getElectronicCertificateForUserVerification(_ session: NFCTagReaderSession,_ individualNumberCard: IndividualNumberCard)-> IndividualNumberCard{
        var individualNumberCard = individualNumberCard
        let tag = individualNumberCard.tag
        let semaphore = DispatchSemaphore(value: 0)
